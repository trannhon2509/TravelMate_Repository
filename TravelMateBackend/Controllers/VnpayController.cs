...
namespace TravelMateBackend.Controllers
{
    ...
    public class VnpayController : ControllerBase
    {
        ...
        public ActionResult<string> RefundPayment(long paymentId, double refundAmount, string description)
        {
            try
            {
                var refundUrl = _vnpay.RefundPayment(paymentId, refundAmount, description);
                return Created(refundUrl, refundUrl);
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);
